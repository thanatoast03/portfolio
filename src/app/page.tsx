    ...
    <main className="flex flex-grow flex-col p-8 lg:p-24 lg:pt-16 bg-[#E9C8B9]">
      <div className="flex flex-col lg:flex-row xl:gap-10 justify-between flex-grow">
        <div className="flex flex-col flex-1 gap-5 lg:gap-16"> 
          {/* text */}
          <TypingText
            text="Hello world! My name is Jack Chin!"
            speed={50}
            className={`text-4xl lg:text-7xl lg:pt-10 lg:mr-10 font-bold drop-shadow-lg ${crimson.className}`}
          />
          ...
          <div className="buttons text-[#222421] flex flex-col sm:flex-row gap-4 lg:gap-4 sm:text-xl font-bold">
            ...
            <button className="bg-[#B2BCA3] px-6 py-3 rounded-xl border-2 border-black flex flex-row gap-4 sm:gap-4 items-center drop-shadow-2xl transition delay-50 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110 hover:bg-[#A3ADA2]" onClick={() => window.open("mailto:jack.chin520@gmail.com", "_blank")}>
